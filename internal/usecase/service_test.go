...
func TestItemUsecase_UpdateItem(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			setupMock: func(mockRepo *MockItemRepository) {
				existingItem, _ := entity.NewItem("アイテム名", "時計", "元のブランド", 1000000, "2023-01-01")
				existingItem.ID = 1
				mockRepo.On("FindByID", mock.Anything, int64(1)).Return(existingItem, nil)

				updatedItem, _ := entity.NewItem("アイテム名", "時計", "更新されたブランド", 1000000, "2023-01-01")
				updatedItem.ID = 1
				mockRepo.On("Update", mock.Anything, mock.AnythingOfType("*entity.Item")).Return(updatedItem, nil)
			},
			expectError: false,
		},
		{
			...
			setupMock: func(mockRepo *MockItemRepository) {
				existingItem, _ := entity.NewItem("アイテム名", "時計", "ブランド", 1000000, "2023-01-01")
				existingItem.ID = 1
				mockRepo.On("FindByID", mock.Anything, int64(1)).Return(existingItem, nil)

				updatedItem, _ := entity.NewItem("アイテム名", "時計", "ブランド", 2000000, "2023-01-01")
				updatedItem.ID = 1
				mockRepo.On("Update", mock.Anything, mock.AnythingOfType("*entity.Item")).Return(updatedItem, nil)
			},
			expectError: false,
		},
		{
			...
			setupMock: func(mockRepo *MockItemRepository) {
				existingItem, _ := entity.NewItem("元の名前", "時計", "元のブランド", 1000000, "2023-01-01")
				existingItem.ID = 1
				mockRepo.On("FindByID", mock.Anything, int64(1)).Return(existingItem, nil)
		...
		},
		{
			...
			setupMock: func(mockRepo *MockItemRepository) {
				existingItem, _ := entity.NewItem("元の名前", "時計", "ブランド", 1000000, "2023-01-01")
				existingItem.ID = 1
				mockRepo.On("FindByID", mock.Anything, int64(1)).Return(existingItem, nil)
			},
			expectError: true,
		...
		},
		{
			...
			setupMock: func(mockRepo *MockItemRepository) {
				existingItem, _ := entity.NewItem("名前", "時計", "ブランド", 1000000, "2023-01-01")
				existingItem.ID = 1
				mockRepo.On("FindByID", mock.Anything, int64(1)).Return(existingItem, nil)
			},
			expectError: true,
